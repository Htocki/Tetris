...
{$IFNDEF FIG_ADD_T_TOP}
{$DEFINE FIG_ADD_T_TOP}

{$I write_form.pas}
{$I write_orientation.pas}
{$I write_position.pas}

{ Добавляет на матрицу состояния фигуру T с ориентацией Top. }
function figAddTTop(var matrix: TMatrix; var position: TPosition): boolean;
begin
